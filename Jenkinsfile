...
node {
        ...
        for (int v = 0; v < variants.length; v++) {
                ...
                def versions = "1.7,1.8,1.9".split(',');
        ...
        */
        ...
        def testApp = openshift.newApp("s2i-golang:${tag}~https://github.com/ausnimbus/golang-ex", "-l app=golang-ex");
        ...
        openshift.tag("ausnimbus-ci/s2i-golang:${tag}", "ausnimbus-staging/s2i-golang:${tag}")
}
